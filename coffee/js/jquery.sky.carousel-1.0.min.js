...
SKY.ImageLoader.prototype = {
    ...
    load: function() {
        var a = this;
        this.img.addEventListener ? this.img.addEventListener("load", 
        function(b) {
            a.onLoad(b)
        },
...
SKY.Timer.prototype = {
    ...
    tick: function() {++this.currentCount;
        this.publish("timer");
...
SKY.CarouselItem.prototype = {
    ...
    update: function() {
        ...
        SKY.Utils.has3dTransformationSupport() && (a += " translateZ(0)"),
        this.element.css(SKY.Utils.getPrefixedProperty("transform"), a),
...
SKY.CarouselItem.createReflection = function(a, b, c) {
    ...
    SKY.Utils.hasCanvasSupport() ? (f = $("<canvas>"), ctx = f.get(0).getContext("2d"), f.attr({
        width: d,
        height: b
    }), f.addClass("reflection"), ctx.save(), ctx.translate(0, g), ctx.scale(1, -1), ctx.drawImage(a.get(0), 0, 0, d, g), ctx.restore(), ctx.globalCompositeOperation = "destination-out", a = ctx.createLinearGradient(0, 0, 0, b), a.addColorStop(0, "rgba(0, 0, 0, " + (1 - c) + ")"), a.addColorStop(1, "rgba(0, 0, 0, 1.0)"), ctx.fillStyle = a, ctx.fillRect(0, 
    0, d, b)) : (f = $("<img>"), f.attr({
        src: a.get(0).src
...
SKY.Container.prototype = {
    ...
    update: function(a) {
        var b = this;
        a ? (this.carousel.onSelectionAnimationStart(), this.element.on("webkitTransitionEnd transitionend oTransitionEnd otransitionend MSTransitionEnd", 
        function(a) {
...
SKY.Carousel.prototype = {
    ...
    initConfigParams: function() {
        ...
        SKY.Utils.has2dTransformationSupport() && this.dom.items.css(SKY.Utils.getPrefixedProperty("transformOrigin"), 
        "center " + Math.round(a.itemHeight / 2) + "px")
    },
    initEvents: function() {
    ...
    initContainer: function() {
        ...
        this.dom.carousel.on(this.events.startEvent, 
        function(b) {
            a.onStart(b)
        });
    ...
    initGradientOverlays: function() {
        ...
        if (a.gradientOverlayVisible) {
            var b = 
            this.createGradientOverlay("left", a.gradientStartPoint, a.gradientEndPoint, a.gradientOverlayColor, a.gradientOverlaySize),
    ...
    initContentWrapper: function() {
        ...
        a.append(this.contentContainer); ! 1 != $.support.leadingWhitespace && this.settings.preload && this.contentContainer.css({
            visibility: "hidden",
            opacity: 0
        });
        this.dom.carousel.append(a);
        $(".sc-content").click(function(){
        	$(".sky-carousel-wrapper").trigger('click');
        });
    },
    ...
    zSort: function(a) {
        ...
        for (var c = 0; c < a.length; c++) a[c].setZIndex(b),
        --b;
    ...
    updateLayout: function() {
        ...
        for (var c = 
        0; c < this.carouselItems.length; c++) {
    ...
    calculateAlpha: function(a) {
        ...
        a) * this.alphaUnit + this.settings.unselectedItemAlpha
    },
    ...
    onStart: function(a) {
        ...
        function c(a) {
            ...
            0 == Math.abs(startX - f) ? (f = $(document.elementFromPoint(f, a)), f.hasClass("sc-image") ? (f.parent().is("a") && (f = f.parent()), f = d.carouselItems[f.parent().index()], g.selectByClick && f !== d.selectedItem ? d.select(f, g.slideSpeed) : g.selectByClick && f === d.selectedItem ? d.selectNext(g.slideSpeed) : f.launchURL()) : g.selectByClick && d.selectNext(g.slideSpeed)) : 
            (0 == e && (0 < Math.abs(m) && d.closestItem.index() == d.selectedItem.index()) && (e = 0 < m ? 1: 0 > m ? -1: 0), h += e, h = 0 > h ? 0: h > k - 1 ? k - 1: h, !u && !q && d.select(h, g.slideSpeed));
            d.dragging = !1;
            d.updateCursor()
        }
        if ("A" != a.target.nodeName) {
            ...
            l = p - (g.itemWidth * g.unselectedItemZoomFactor + 
            g.distance) * (k - 1),
    ...
    createGradientOverlay: function(a, b, c, d, g) {
        if (SKY.Utils.hasCanvasSupport()) {
            var f = 
            $('<canvas class="sc-overlay" width="' + g + '" height="1"></canvas'),
...
window.Modernizr = function(a, b, c) {
    ...
    w = function(a, c, d, e) {
        ...
        if (parseInt(d, 10)) for (; d--;) k = b.createElement("div"),
        k.id = e ? e[d] : "modernizr" + (d + 1),
        l.appendChild(k);
        return f = ['&#173;<style id="smodernizr">', a, "</style>"].join(""),
        l.id = "modernizr",
        (n ? l: m).innerHTML += f,
        m.appendChild(l),
        n || (m.style.background = "", m.style.overflow = 
        "hidden", p = h.style.overflow, h.style.overflow = "hidden", h.appendChild(m)),
        g = c(l, a),
        n ? l.parentNode.removeChild(l) : (m.parentNode.removeChild(m), h.style.overflow = p),
        !!g
    },
    x = {}.hasOwnProperty,
    v; ! d(x, "undefined") && !d(x.call, "undefined") ? v = function(a, b) {
        return x.call(a, b)
    }: v = function(a, b) {
    ...
    k.touch = function() {
        ...
        l.join("touch-enabled),("), "modernizr){#modernizr{top:9px;position:absolute}}"].join(""), 
        function(a) {
            c = 9 === a.offsetTop
        }),
        c
    ...
    k.csstransforms3d = function() {
        var a = !!f("perspective");
        return a && "webkitPerspective" in h.style && w("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", 
        function(b, c) {
    ...
    h.className = h.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + t.join(" ")),
    e
} (this, this.document);